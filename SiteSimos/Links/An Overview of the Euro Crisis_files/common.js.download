...
NYTD.jQuery = jQuery.noConflict(true);

/*
 * $Id: common.js 156847 2017-11-06 18:12:25Z gopi_borra $
...
(function() {
  ...
  if (
    ...
    !(
      window.location.pathname.match(/^\/portals/) &&
      window.location.hostname == 'www.nytimes.com'
    ) &&
    !document.referrer.match(regexp) &&
    !window.top.location.match(regexp)
  ) {
...
function writeFlashSlideShow(xmlFile) {
  var swfFile =
    '/slideshow/swf/slideshow.swf?XMLfile=/slideshow/xml/travel/' + xmlFile;
  var HTMLstr = '';
  HTMLstr +=
    '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="390" height="300" id="slideshow" align="middle">';
  ...
  HTMLstr +=
    '<embed src="' +
    swfFile +
    '" wmode="transparent" quality="high" width="390" height="300" name="slideshow" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
  HTMLstr += '</object>';
  return HTMLstr;
}
...
function showFirstSlide(imgName, photoCredit, photoCaption) {
  ...
  HTMLstr += '<!-- begin photo -->';
  HTMLstr +=
    '<img src="http://graphics.nytimes.com/images/section/travel/slideshow/' +
    imgName +
    '" width="390" height="200" alt="photo" border="0">';
  HTMLstr += '<!-- end photo -->';
...
function writeEmbeddedFlashSlideShow(xmlFile) {
  var swfFile =
    '/slideshow/swf/slideshow.swf?XMLfile=/slideshow/xml/' + xmlFile;
  var HTMLstr = '';
  HTMLstr +=
    '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="390" height="300" id="slideshow" align="middle">';
  HTMLstr += '<param name="allowScriptAccess" value="sameDomain" />';
  ...
  HTMLstr +=
    '<embed src="' +
    swfFile +
    '" wmode="transparent" qualityaigh" width="390" height="300" name="slideshow" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
  HTMLstr += '</object>';
  return HTMLstr;
}
...
function readCookie(value) {
  ...
  for (var i = 0; i < allCookieVals.length; i++) {
    ...
    if (allCookieVals[i].indexOf(value) != -1) {
      //find target cookie
...
function setClientSizeCookies() {
  ...
  document.cookie =
    'client_w=' + client_w + '; path= ' + path + '; domain=' + domain;
}
...
NYTD.Hosts = (function() {
  ...
  for (var i = 0, script; (script = scripts[i]); i++) {
    host =
      script.src && /^(.+\.nyt(imes)?.com)\/js\/common\.js/.test(script.src)
        ? RegExp.$1
        : '';
    if (host) {
      break;
  ...
  NYTD.require = function(file, callback) {
    ...
    if (force || !scriptLoaded(url)) {
      document.write(
        '<script src="' +
          url +
          '" type="text/javascript" charset="utf-8" onerror="throw(\'NYTD.require: An error occured: \' + this.src)"></script>'
      );
  ...
  if (
    ...
    NYTD.jQuery('#shell').before(
      '<div class="retiredMessage">' +
        ...
        highlightMsg +
        '</p>' +
        '<p class="sectionMsg">For the latest Health news, <a href="https://www.nytimes.com/section/health">visit our Health section</a>. ' +
        'Questions? <a href="https://www.nytimes.com/help/index.html">Visit our directory</a> for a comprehensive list of contact options.</p>' +
        '</div>'
    );
  }
});
    ...
    addModalToPage: function(selector) {
      ...
      var buildTemplate = function() {
        ...
        for (i = 0, arrLen = options.listItems.length; i < arrLen; i += 1) {
          ...
          listItemArray.push(
            '<li class="',
            options.listItems[i].className || '',
            '"><a href="',
            options.listItems[i].href,
            '" ',
            target,
            '>',
        ...
        return [
          ...
          '<a class="dropDownModalLink" href="javascript:;">',
          options.linkText.replace(/\s/, '&nbsp;'),
          '</a>',
          '</div>',
  ...
  var overlayPrototype = {
    initialize: function(options) {
      ...
      this.addToPage = function(nodeToAppendTo) {
        ...
        var html = [
          '<div id="',
          options.uniqueId + 'Container',
          '" class="',
          options.uniqueId + 'Container nytModalContainer',
          '" style="display:none; z-index:2147483645;">',
          '<div class="nytOverlay" style="',
          backgroundStyle,
          '"></div>',
          '<div class="nytModal ',
          options.uniqueId + ' ',
          ...
          '</div>',
          '</div>',
          '<div class="nytModalPointer nytModalPointer' +
            arrowProperties.appendToClass +
            '" style="' +
            arrowProperties.inlineStyles +
            '"></div>',
          '</div>',
          '</div>'
        ].join('');
...
(function(jQuery) {
  ...
  var modalRegiHtml = [
    ...
    '<form validate id="regiModalForm" class="regiModalForm modalForm" method="post" action="https://myaccount.nytimes.com/register?URI=',
    ...
    '<span id="submitRegiLoader" class="submitLoader hidden"><img src="https://i1.nyt.com/images/loaders/loading-grey-lines-circle-18.gif"></span>',
  ...
  var modalLoginHtml = [
    ...
    '<form id="loginModalForm" class="loginModalForm" method="post" action="https://myaccount.nytimes.com/auth/login?URI=',
    window.encodeURIComponent(window.location.href),
    '">',
    '<div class="control">',
    '<div class="labelContainer">',
    ...
    '<div class="control buttonControl">',
    '<span id="loginSubmitLoader" class="submitLoader hidden"><img src="https://i1.nyt.com/images/loaders/loading-grey-lines-circle-18.gif"></span>',
