...
;var F={},G=null;var H="function"===typeof Uint8Array;var I="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function J(a){var b;I?b=a[I]:b=a.m;return null==b?0:b}
...
var M=Object.freeze(K([]));function da(a){a=a.i;if(Array.isArray(a)&&J(a)&2)throw Error("Cannot mutate an immutable Message");}
var ea="undefined"!=typeof Symbol&&"undefined"!=typeof Symbol.hasInstance;function N(a){return{value:a,configurable:!1,writable:!1,enumerable:!1}}
;function fa(a){ea&&Object.defineProperty(a,Symbol.hasInstance,N(Object[Symbol.hasInstance]))}
...
;function O(a,b,c){a||(a=ma);ma=null;var d=this.constructor.j;a||(a=d?[d]:[]);this.g=(d?0:-1)-(this.constructor.g||0);this.o=void 0;this.i=a;a:{d=this.i.length;a=d-1;if(d&&(d=this.i[a],L(d))){this.j=a-this.g;this.l=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.g),this.l=void 0):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.j)a+=this.g,(d=this.i[a])?Array.isArray(d)&&K(d):this.i[a]=M;else{d=this.l||(this.l=this.i[this.j+this.g]={});var h=d[a];h?Array.isArray(h)&&K(h):
d[a]=M}}
O.prototype.toJSON=function(){return ha(this.i)};
O.prototype.toString=function(){return this.i.toString()};
var ma;function P(){O.apply(this,arguments)}
B(P,O);function na(a,b){var c=this.g,d=!0;d=void 0===d?!1:d;da(a);a.o||(a.o={});var h=b?b.i:b;a.o[c]=b;b=d;b=void 0===b?!1:b;da(a);c<a.j&&!b?a.i[c+a.g]=h:(a.l||(a.l=a.i[a.j+a.g]={}))[c]=h;return a}
;function Q(){P.apply(this,arguments)}
B(Q,P);if(ea){var oa={};Object.defineProperties(P,(oa[Symbol.hasInstance]=N(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),oa));
var pa={};Object.defineProperties(Q,(pa[Symbol.hasInstance]=N(Object[Symbol.hasInstance]),pa))};var R=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function qa(a){return a?decodeURI(a):a}
;function S(a){Q.call(this,a,1)}
B(S,Q);function T(a){Q.call(this,a)}
B(T,Q);var ra=new function(a){this.g=a;this.j=na}(406606992,T);function U(){T.apply(this,arguments)}
