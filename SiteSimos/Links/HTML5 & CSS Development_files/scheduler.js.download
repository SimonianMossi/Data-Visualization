...
function r(a,b){a.prototype=da(b.prototype);a.prototype.constructor=a;if(q)q(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.W=b.prototype}
...
;var ia={},y=null;var ja="function"===typeof Uint8Array;var z="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function ka(a){var b;z?b=a[z]:b=a.B;return null==b?0:b}
function B(a){Object.isFrozen(a)||(z?a[z]|=1:void 0!==a.B?a.B|=1:Object.defineProperties(a,{B:{value:1,configurable:!0,writable:!0,enumerable:!1}}));return a}
;function la(a){return null!==a&&"object"===typeof a&&!Array.isArray(a)&&a.constructor===Object}
var ma=Object.freeze(B([]));function na(a){a=a.j;if(Array.isArray(a)&&ka(a)&2)throw Error("Cannot mutate an immutable Message");}
var oa="undefined"!=typeof Symbol&&"undefined"!=typeof Symbol.hasInstance;function C(a){return{value:a,configurable:!1,writable:!1,enumerable:!1}}
;function pa(a){oa&&Object.defineProperty(a,Symbol.hasInstance,C(Object[Symbol.hasInstance]))}
;function qa(a){var b=ra;b=void 0===b?sa:b;return ta(a,b)}
function ua(a,b){if(null!=a){if(Array.isArray(a))a=ta(a,b);else if(la(a)){var c={},d;for(d in a)c[d]=ua(a[d],b);a=c}else a=b(a);return a}}
function ta(a,b){for(var c=a.slice(),d=0;d<c.length;d++)c[d]=ua(c[d],b);Array.isArray(a)&&ka(a)&1&&B(c);return c}
function ra(a){if(a&&"object"==typeof a&&a.toJSON)return a.toJSON();a:switch(typeof a){case "number":a=isFinite(a)?a:String(a);break a;case "object":if(a&&!Array.isArray(a)&&ja&&null!=a&&a instanceof Uint8Array){var b;void 0===b&&(b=0);if(!y){y={};for(var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),d=["+/=","+/","-_=","-_.","-_"],e=0;5>e;e++){var f=c.concat(d[e].split(""));ia[e]=f;for(var g=0;g<f.length;g++){var k=f[g];void 0===y[k]&&(y[k]=g)}}}b=ia[b];c=Array(Math.floor(a.length/
...
function sa(a){return ja&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
;function D(a,b,c){a||(a=va);va=null;var d=this.constructor.h;a||(a=d?[d]:[]);this.g=(d?0:-1)-(this.constructor.g||0);this.l=void 0;this.j=a;a:{d=this.j.length;a=d-1;if(d&&(d=this.j[a],la(d))){this.h=a-this.g;this.i=d;break a}void 0!==b&&-1<b?(this.h=Math.max(b,a+1-this.g),this.i=void 0):this.h=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.h)a+=this.g,(d=this.j[a])?Array.isArray(d)&&B(d):this.j[a]=ma;else{d=this.i||(this.i=this.j[this.h+this.g]={});var e=d[a];e?Array.isArray(e)&&B(e):
d[a]=ma}}
...
r(E,D);function wa(a,b){var c=this.g,d=!0;d=void 0===d?!1:d;na(a);a.l||(a.l={});var e=b?b.j:b;a.l[c]=b;b=d;b=void 0===b?!1:b;na(a);c<a.h&&!b?a.j[c+a.g]=e:(a.i||(a.i=a.j[a.h+a.g]={}))[c]=e;return a}
;function F(){E.apply(this,arguments)}
r(F,E);if(oa){var xa={};Object.defineProperties(E,(xa[Symbol.hasInstance]=C(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),xa));
var ya={};Object.defineProperties(F,(ya[Symbol.hasInstance]=C(Object[Symbol.hasInstance]),ya))};function G(){this.u=this.u;this.D=this.D}
...
r(H,F);function I(a){F.call(this,a)}
r(I,F);var za=new function(a){this.g=a;this.h=wa}(406606992,I);function J(){I.apply(this,arguments)}
r(J,I);pa(J);var K,L,M,N=u.window,O=(null===(K=null===N||void 0===N?void 0:N.yt)||void 0===K?void 0:K.config_)||(null===(L=null===N||void 0===N?void 0:N.ytcfg)||void 0===L?void 0:L.data_)||{},Aa=(null===(M=null===N||void 0===N?void 0:N.ytcfg)||void 0===M?void 0:M.obfuscatedData_)||[];function P(){H.apply(this,arguments)}
r(P,H);pa(P);var Ba=new P(Aa),Ca=O.EXPERIMENT_FLAGS;if(!Ca||!Ca.jspb_i18n_extension){var Da=new J;za.h(Ba,Da)}x("yt.config_",O);x("yt.configJspb_",Aa);function Q(a,b){return a in O?O[a]:b}
...
function R(a){a=void 0===a?{}:a;G.call(this);this.g=[];this.g[8]=[];this.g[4]=[];this.g[3]=[];this.g[2]=[];this.g[1]=[];this.g[0]=[];this.l=0;this.P=a.timeout||1;this.i={};this.s=Ha;this.F=this.h=this.o=0;this.G=this.m=!1;this.v=[];this.J=w(this.T,this);this.O=w(this.V,this);this.L=w(this.R,this);this.M=w(this.S,this);this.N=w(this.U,this);this.C=this.H=!1;var b;if(b=!!window.requestIdleCallback)b=Fa("disable_scheduler_requestIdleCallback"),b=!("string"===typeof b&&"false"===b?0:b);this.K=b;(this.A=
!!a.useRaf&&!!window.requestAnimationFrame)&&document.addEventListener("visibilitychange",this.J)}
r(R,G);function Ia(a,b){var c=Date.now();S(b);b=Date.now()-c;a.m||(a.s-=b)}
...
h.I=function(){Ka(this);U(this);this.A&&document.removeEventListener("visibilitychange",this.J);G.prototype.I.call(this)};var W=v("yt.scheduler.instance.timerIdMap_")||{},Oa=Ea("kevlar_tuner_scheduler_soft_state_timer_ms",800),X=0,Y=0;function Z(){var a=v("ytglobal.schedulerInstanceInstance_");if(!a||a.u)a=new R(Q("scheduler",void 0)||{}),x("ytglobal.schedulerInstanceInstance_",a);return a}
